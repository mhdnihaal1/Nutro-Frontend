...
const EditItemModal : React.FC<AddItemModalProps> = ({
    ...
    const submitHandler = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        if (!validateForm()){ console.log('wrong'); return; }  ;
  ...
  <div className="flex items-center mb-2">
    ...
    <input
      ...
      onChange={(e) => setPrices({ ...prices, dryClean: Number(e.target.value) })}
  ...
  <div className="flex items-center mb-2">
    ...
    <input
      ...
      required
      value={prices.wash}
      onChange={(e) => setPrices({ ...prices, wash: Number(e.target.value) })}
      className="flex-1 p-2 bg-gray-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-blue-600"
    />
  </div>
  ...
  <div className="flex items-center">
    ...
    <input
      ...
      required
      value={prices.iron}
      onChange={(e) => setPrices({ ...prices, iron: Number(e.target.value) })}
      className="flex-1 p-2 bg-gray-700 text-white rounded-lg outline-none focus:ring-2 focus:ring-blue-600"
    />
  </div>
</div>
