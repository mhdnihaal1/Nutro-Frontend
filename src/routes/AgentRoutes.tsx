...
const AgentAcceptedOrdersPage = lazy(
  () => import("../pages/agent/AgentAcceptedOrders")
);
const AgentOrderHistoryPage = lazy(
  () => import("../pages/agent/AgentOrderHistory")
);
const AgentRequestDetailsPage = lazy(
  () => import("../pages/agent/AgentRequestDetails")
);
...
const AgentChangePasswordPage = lazy(
  () => import("../pages/agent/AgentChangePassword")
);
    ...
    <Suspense fallback={<LoadSpinner />}>
      <Routes>
        <Route element={<AgentProtected />}>
          ...
          <Route
            path="requestDetails/:orderId"
            element={<AgentRequestDetailsPage />}
          />
