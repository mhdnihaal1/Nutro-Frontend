...
const AdminServices = () => {
  ...
  <div className="flex-grow p-2 sm:p-6 lg:p-8 md:ml-64">
    <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">Manage Services</h1>
          ...
          <ul className="space-y-4">
            {service.map((service) => (
              ...
              >
                ...
                <p className="text-gray-400 truncate">{"service.description"}</p>
                <p className="text-gray-400 truncate">{"service.features"}</p>
              </li>
            ))}
          </ul>
        )}
