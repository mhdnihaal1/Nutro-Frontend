...
export const placeOrder = async (
  ...
  try {
    const response = await Api.post(userRoute.placeOrder, {
      userId,
      selectedAddress,
      cartTotal,
      selectedMode,
...
export const changePassword = async (
  ...
  try {
    const response = await Api.post(userRoute.changePassword, {
      _id: UserId,
      currentPassword,
      newPassword,
    });
...
export const sendConcern = async (
  UserId: string,
  subject: string,
  summary: string
) => {
  try {
    const response = await Api.post(userRoute.sendConcern, {
      id: UserId,
      subject: subject,
      summary: summary,
    });
...
export const sendEmail = async (email: string, otp: string) => {
  try {
    const response = await Api.post(userRoute.sendEmail, {
      email: email,
      otp: otp,
    });
    return response;
...
export const SavePassword = async (password: string, email: string) => {
  try {
    const response = await Api.post(userRoute.SavePassword, {
      password: password,
      email: email,
    });
    return response;
