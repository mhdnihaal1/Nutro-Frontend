...
export const getAgentOrders = async (agentId:string) => {
    try {
      const response = await Api.post(agentRoute.getAgentOrders,{agentId:agentId});
      return response;
    } catch (error) {
      const err: Error = error as Error;
      return errorHandle(err);
  ...
  export const oldPasswordcheck = async (Agent:string,oldPassword:string) => {
    try {
      const response = await Api.post(agentRoute.oldPasswordcheck,{id:Agent,password:oldPassword});
      return response;
    } catch (error) {
      const err: Error = error as Error;
      return errorHandle(err);
  ...
  export const changePassword = async (Agent:string,newPassword:string) => {
    try {
      const response = await Api.post(agentRoute.changePassword,{id:Agent,password:newPassword});
      return response;
    } catch (error) {
      const err: Error = error as Error;
      return errorHandle(err);
  ...
  export const sendOtp = async (Agentemail:string,otp:string) => {
    try {
      const response = await Api.post(agentRoute.sendOtp,{email:Agentemail,otp:otp});
      return response;
    } catch (error) {
      const err: Error = error as Error;
      return errorHandle(err);
